...
# When compiling to .exe, move any _rc.py files to the same dir as this file so
# QT autogenerated imports in UI files (stampCalculatorUI) don't break
# Below is an interpreter runtime fix for ^
sys.path.append("gui")
